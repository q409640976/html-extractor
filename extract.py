...
if __name__ == '__main__':
	...
	parser.add_argument('-w', '--ftl', action='store_true', help='defualt html but --ftl')
	parser.add_argument('-v', '--videos', action='store_true', help='download videos')
	parser.add_argument('--html', '--html', action='store_true', help='download videos')
	...
	if not args.output:
		main(args.url, "./" + get_md5_value(args.url) )
	else:
